...
DoTimerSW_BaseDurations = {
	...
	-- 圣骑士 (PALADIN)
	-- ========================================================
	[20186] = { ["duration"] = 10, ["multiplier"] = 1 },   -- 智慧审判 (Judgement of Wisdom) - Rank 1
	[20185] = { ["duration"] = 10, ["multiplier"] = 1 },   -- 光明审判 (Judgement of Light) - Rank 1
	...
	-- 乌龟服新增技能
	[12303] = { ["duration"] = 3,  ["multiplier"] = 1 },   -- 责难/挑衅 (Provocation) - 防骑单体嘲讽

	-- ========================================================
	-- 术士 (WARLOCK)
	-- ========================================================
	[1714]   = { ["duration"] = 30, ["multiplier"] = 1 },   -- 语言诅咒 (Curse of Tongues) - Rank 1
	...
	[702]   = { ["duration"] = 2,  ["multiplier"] = 60 },  -- 虚弱诅咒 (Curse of Weakness) - Rank 1
	...
	[19244] = { ["duration"] = 6,  ["multiplier"] = 1 },   -- 法术封锁 (Spell Lock) - Rank 1
	...
	-- 德鲁伊 (DRUID)
	-- ========================================================
	[1079]  = { ["duration"] = 12, ["multiplier"] = 1 },   -- 撕扯 (Rip) - Rank 1
	...
	[16979]  = { ["duration"] = 4,  ["multiplier"] = 1 },   -- 野性冲锋 (Feral Charge)
	...
	-- 乌龟服新增技能
	[24118] = { ["duration"] = 10, ["multiplier"] = 1 },   -- 割伤 (Lacerate) - Rank 1 (近战生存猎核心流血DOT)
	...
	[1008]  = { ["duration"] = 10, ["multiplier"] = 60, ["hideMain"] = true }, -- 魔法增效 - Rank 1 (10分钟)
	
	-- 对齐技能书“1小时”文本逻辑（1 hour = 1 * 3600秒）
	[23028] = { ["duration"] = 1,  ["multiplier"] = 3600,["hideMain"] = true }, -- 奥术光辉 - Rank 1
	
	-- 乌龟服新增技能
	--[11242] = { ["duration"] = 6,  ["multiplier"] = 1 },   -- 奥术冲击 (Arcane Blast) - 技能层数Buff持续6秒
	...
	[14251] = { ["duration"] = 6,   ["multiplier"] = 1 },   -- 还击 (Riposte) - Rank 1
	...
	[16164] = { ["duration"] = 6,  ["multiplier"] = 1 },   -- 元素集中 (Focused Casting)
	[8056]  = { ["duration"] = 8,  ["multiplier"] = 1 },   -- 冰霜震击 (Frost Shock) - Rank 1
	[8177]  = { ["duration"] = 45, ["multiplier"] = 1 },   -- 根基图腾 (Grounding Totem)
	[29203] = { ["duration"] = 15, ["multiplier"] = 1 },   -- 治疗之道 (Healing Way)
	[16190] = { ["duration"] = 12, ["multiplier"] = 1 },   -- 法力潮汐图腾 (Mana Tide Totem) - Rank 1
	[17364] = { ["duration"] = 12, ["multiplier"] = 1 },   -- 风暴打击 (Stormstrike)
	-- 萨满长 Buff 技能
	[546]   = { ["duration"] = 10, ["multiplier"] = 60, ["hideMain"] = true }, -- 水上行走 (10分钟)
	[131]  = { ["duration"] = 10, ["multiplier"] = 60, ["hideMain"] = true }, -- 水下呼吸 (10分钟)
	
	-- 乌龟服新增技能
	[45525] = { ["duration"] = 10, ["multiplier"] = 60, ["hideMain"] = true }, -- 大地之盾 (Earth Shield) - Rank 1 (恢复萨大招，持续10分钟)

	-- ========================================================
	-- 宠物相关技能 (Pet Spells)
	-- ========================================================
	[2649]  = { ["duration"] = 3,  ["multiplier"] = 1 },   -- 低吼 (Growl) - Rank 1
	[24640] = { ["duration"] = 10, ["multiplier"] = 1 },   -- 蝎毒 (Scorpid Poison) - Rank 1
	[745] = { ["duration"] = 2,  ["multiplier"] = 1 },   -- 丝网 (Web) - Rank 1
	[7812] = { ["duration"] = 30, ["multiplier"] = 1 },   -- 牺牲 (Sacrifice) - 虚空行者盾 - Rank 1
	[6358]  = { ["duration"] = 15, ["multiplier"] = 1 },   -- 诱惑 (Seduction) - 魅魔 - Rank 1
	[19478] = { ["duration"] = 30, ["multiplier"] = 1 },   -- 污染之血 (Tainted Blood) - 地狱犬 - Rank 1
}